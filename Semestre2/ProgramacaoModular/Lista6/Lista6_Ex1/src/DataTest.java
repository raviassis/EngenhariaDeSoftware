...
public class DataTest {
	...
	public void testeConstrutor() {
		...
		assertEquals(d3.getDayOfMonth(), d.getDia());
		assertEquals(d3.getMonthValue(), d.getMes());
		assertEquals(d3.getYear(), d.getAno());
		
	}
	
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeGetDia() throws ExcecaoDataInvalida {
		Data d = new Data(2018, 02, 03);
		assertEquals(3, d.getDia());		
	}
	
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeGetMes() throws ExcecaoDataInvalida {
		Data d = new Data(2018, 02, 03);
		assertEquals( 2, d.getMes() );
	}
	
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeGetAno() throws ExcecaoDataInvalida {
		Data d = new Data(2018, 02, 03);
		assertEquals( 2018, d.getAno() );
	}
	
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeAdicionaDias() throws ExcecaoDataInvalida {
		...
		//adiciona 40 dias
		d = new Data(2018,01,22);
		d2 = new Data(2018, 03, 03);
		d.adicionaDias(40);
		assertEquals(d2.getDia(), d.getDia());
		assertEquals(d2.getMes(), d.getMes() );
		assertEquals(d2.getAno(), d.getAno());
	...
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeDiasNoMes() throws ExcecaoDataInvalida {
	...
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeDiaDaSemana() throws ExcecaoDataInvalida {
	...
	@Test(timeout = DEFAULT_TIMEOUT)
	public void teste_eBissexto() throws ExcecaoDataInvalida {
	...
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeProximoDia() throws ExcecaoDataInvalida {
	...
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeDataExtenso() throws ExcecaoDataInvalida {
	...
	@Test(timeout = DEFAULT_TIMEOUT)
	public void testeMenorQue() throws ExcecaoDataInvalida{
		Data d1 = new Data(2018, 03, 03);
		Data d2 = new Data(2017, 03, 03);
		assertTrue("Metodo retornou false",d2.menorQue(d1));
		assertFalse("Metodo retornou true", d1.menorQue(d2));
	}
